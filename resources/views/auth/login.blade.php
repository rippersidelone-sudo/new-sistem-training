                            ...
                            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="role" name="role" required
                                            ...
                                            @change="showToken = (selectedRole !== '' && selectedRole !== 'Participant')"
                                            class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#10AF13] focus:border-transparent transition duration-150 cursor-pointer">
                                ...
                                <!-- Token Field - muncul otomatis saat role dipilih (kecuali Participant) -->
                                <div x-show="showToken" x-transition.opacity.duration.300ms class="transition-all duration-300 ease-in-out">
                                    <label for="token" class="block text-sm font-medium text-gray-700 mb-2">Token Akses</label>
                                    <input id="token" type="password" name="token" value="{{ old('token') }}"
