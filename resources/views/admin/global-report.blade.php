{{-- resources/views/admin/reports/index.blade.php - IMPROVED VERSION --}}
...
@section('content')
    <div class="px-2 flex justify-between items-start">
        <div>
            ...
            <p class="text-[#737373] mt-2 font-medium">Laporan komprehensif pelatihan</p>
        </div>
            ...
            <div class="bg-white border rounded-2xl p-6 mt-8 mx-2">
                ...
                @if($branchPerformance->isEmpty())
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <p class="font-medium">Belum ada data cabang dalam periode ini</p>
                    </div>
                @else
        ...
        <div x-show="tab === 'analisis-performa'">
            <div class="bg-white border rounded-2xl p-6 mt-8 mx-2">
                ...
                <div class="text-center py-12 text-gray-500">
                    ...
                    <p class="text-sm mt-1">Top performing batches akan muncul setelah ada batch yang completed dalam periode {{ $dateRange['label'] }}</p>
                </div>
                @else
                <div class="space-y-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const cabangCtx = document.getElementById('cabangChart');
            if (cabangCtx) {
                ...
                if (branchData.length > 0) {
                    new Chart(cabangCtx, {
                        type: 'bar',
                        data: {
                            labels: branchData.map(b => b.name.substring(0, 15)),
                            datasets: [
                                {
                                ...
                                tooltip: {
                                    ...
                                    callbacks: {
                                        title: function(context) {
                                            return branchData[context[0].dataIndex].name;
                                        }
                                    }
                                }
                            },
