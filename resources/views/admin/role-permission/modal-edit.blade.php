...
<div x-show="openEditUser" x-cloak x-transition class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
    <div @click.outside="openEditUser = false"
        ...
        <div class="overflow-y-auto flex-1 px-6 pt-6">
            <form method="POST" :action="`{{ url('admin/users') }}/${selectedUser.id}`" id="editUserForm"
                x-data="{
                ...
                <div class="space-y-5 pb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" required
                            x-effect="$el.value = selectedUser.name ?? ''"
                    ...
                    <div>
                        ...
                        <input type="text" name="username" required
                            x-effect="$el.value = selectedUser.username ?? ''"
                            :placeholder="selectedUser.username || 'Masukkan username unik'"
                            class="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-[#10AF13] focus:ring-2 focus:ring-[#10AF13]/30 transition">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" required
                            x-effect="$el.value = selectedUser.email ?? ''"
                    ...
                    <div class="relative z-30" id="editRoleDropdownContainer">
                        ...
                        <button type="button"
                            ...
                            <span :class="editRoleName ? 'text-gray-900' : 'text-gray-400'"
                                  x-text="editRoleName || 'Pilih Role'"></span>
                                ...
                                <template x-for="role in roles" :key="role.id">
                                    <button type="button"
                                        ...
                                        <span x-text="role.name" class="text-sm font-medium"
                                              :class="editRoleId == role.id ? 'text-[#10AF13]' : 'text-gray-700'"></span>
                                        <svg x-show="editRoleId == role.id" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                    ...
                    <div x-show="showBranchEdit" x-transition class="relative z-20" id="editBranchDropdownContainer">
                        ...
                        <button type="button"
                            ...
                            <span :class="editBranchName ? 'text-gray-900' : 'text-gray-400'"
                                  x-text="editBranchName || 'Pilih Cabang'"></span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor" stroke-width="2"
                                ...
                                <template x-for="branch in branches" :key="branch.id">
                                    <button type="button"
                                        ...
                                        <span x-text="branch.name" class="text-sm font-medium"
                                              :class="editBranchId == branch.id ? 'text-[#10AF13]' : 'text-gray-700'"></span>
                                        <svg x-show="editBranchId == branch.id" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                             viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="text-[#10AF13]">
                                            <path d="M5 12l5 5l10 -10" />
                                        </svg>
                                    </button>
