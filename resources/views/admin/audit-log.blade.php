    ...
    <div class="bg-white border rounded-2xl p-6 mt-8 mx-2">
        <div class="flex justify-between items-center mb-5">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Total: {{ $auditLogs->count() }} aktivitas
                    @if(request()->hasAny(['search', 'action', 'role_id']))
                        <span class="text-[#10AF13]">(filtered)</span>
                    @endif
                </p>
            </div>
        </div>
        ...
        @else
            ...
            <div class="mt-6 pt-4 border-t">
                <p class="text-sm text-[#10AF13] font-medium text-center">
